            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    <div class="card" style="background-color: rgb(46, 44, 44); box-shadow: rgb(228, 166, 51) 5px 6px 12px;">
                        <div class="card-body">
                            <h1 style="text-align:center; color: rgb(228, 166, 51); font-family: 'Quintessential', cursive;"><b>Kelola Data Area</b></h1>
                        </div>
                    ...
                    <div class="col-sm-6 text-end">
                      <ol class="breadcrumb mb-4">
                          ...
                          <li class="breadcrumb-item active" style="color: rgb(228, 166, 51)">Data Area</li>
                      </ol>
                  </div>
    ...
    <div class="container">
        <div class="card" style="box-shadow: rgb(228, 166, 51) 5px 6px 12px; background-color: rgb(37, 36, 36);">
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div style="display: inline-block;">
                                        <form action="{{ route('area.delete', $row->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" style="background: none; border: none; padding: 0; cursor: pointer;">
                ...
                <a href="/areas/insert"><i class="fas fa-plus-circle fa-3x"
