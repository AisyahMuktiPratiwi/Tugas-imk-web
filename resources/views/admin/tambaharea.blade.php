        ...
        <div class="card shadow-sm" style="background-color: rgb(37, 36, 36);">
            <div class="card-body">
                <div class="card" style="background-color: rgb(65, 61, 61); color: rgb(228, 166, 51); box-shadow: 5px 6px 12px rgb(228, 166, 51);">
                    <h2 class="text-center" style="font-family: 'Quintessential', cursive;"><b>Add Data Area</b></h2>
                </div>

                <ol class="breadcrumb mb-4" style="background-color: rgb(37, 36, 36);">
                    <li class="breadcrumb-item"><a href="" style="color:rgb(228, 166, 51)">Add Data Area</a></li>
                    <li class="breadcrumb-item active"><a href="/areas" style="color:white"> Data Area </a></li>
                </ol>

                <form action="{{route('area.store')}}" method="POST" enctype="multipart/form-data" style="color:rgb(228, 166, 51);">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12 d-flex mb-3">
                            ...
                            <div class="col-md-4" style="width: 33.3333%;">
                                ...
                                <input type="text" name="name" class="form-control" required style="background:none; color:rgb(228, 166, 51); border-color:rgb(228, 166, 51);">
                            </div>

                      
                            <div class="col-md-4" style="width: 33.3333%;">
                                <label for="harga" class="form-label">Price</label>
                                <input type="text" class="form-control" name="price" required style="background:none; border-color: rgb(228, 166, 51); color:rgb(228, 166, 51);">
                            </div>
                            <div class="col-md-4  ">
                        ...
                        <br>    <div class="col-md-12 d-flex mb-3">
                                 <div class="col-md-8" style="width: 66.6667%;">
                                <label for="deskripsi" class="form-label">Description</label><br>
                                <textarea id="deskripsi" name="description" 
                                    style="border-color: rgb(228, 166, 51); color: rgb(228, 166, 51); background: none; width: 90%; height: 150px;"></textarea>
                            </div>
                        ...
                        <div class="col-md-12 d-flex mb-3">
                            ...
                            <div class="col-md-12 d-flex ">
                                <button type="submit" class="btn btn-primary" style="background-color: rgb(228, 166, 51);rounded:90%;width:15%;color:rgb(160, 0, 0)">Submit</button>
                            </div>
                        </div>
